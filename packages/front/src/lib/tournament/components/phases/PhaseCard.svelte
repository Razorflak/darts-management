<script lang="ts">
	import type { Phase, GroupPhase, EliminationPhase } from '../../types.js'
...
<div class="rounded-lg border border-gray-200 bg-white shadow-sm">
	...
	<div class="flex items-center gap-3 p-4">
		...
		<span
			data-drag
			class="cursor-grab select-none text-xl text-gray-300 hover:text-gray-500 active:cursor-grabbing"
			aria-hidden="true"
		>
			⠿
		</span>
		...
		<div class="ml-auto flex shrink-0 items-center gap-1">
			...
			{/if}
			<Button size="xs" color="red" outline pill onclick={onDelete} aria-label="Supprimer la phase">
			...
			<div class="grid grid-cols-2 gap-4">
				<div>
					...
					<Input
						...
						type="number"
						bind:value={phase.playersPerGroup}
						min="2"
						class="text-center"
					/>
				</div>
	...
	{#if isEliminationPhase(phase) && expanded}
		<div class="space-y-3 border-t border-gray-200 px-4 pb-4 pt-3">
			{#if !isLast}
